  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: <Widget>[
      Center(
        ...
        children: [
          const Text("What is your target weight?", style: TextStyle(fontSize: 25.0, color: Colors.white, fontFamily: 'Work_Sans',)),
          const SizedBox(height: 10),
          // ignore: sized_box_for_whitespace
          Container(
            width: MediaQuery.of(context).size.width * 0.76,
            child: const Text(
              "Your current BMI is 21.04 which is in the normal range Loose 1.0 Kg..",
